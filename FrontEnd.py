...
from projectsTable import ProjectsList
...
with col2:
    ...
    if selected_projects:
        project_reductions = [selected_df[col].sum() for col in pollutant_columns]
...
# else:
#     st.info("👆 Select projects from the checklist above to see their emissions impact!")
